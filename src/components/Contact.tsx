...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 px-4 relative overflow-hidden" ref={ref} aria-labelledby="contact-heading">
      {/* Background Effects */}
      ...
      <div className="container max-w-5xl relative">
        <header className={`text-center mb-12 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 id="contact-heading" className="text-3xl md:text-5xl font-display font-bold mb-4">
        ...
        <div className={`relative transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
          {/* Glow Effect */}
          <div className="absolute -inset-1 rounded-3xl blur-xl opacity-50" style={{ background: 'var(--gradient-primary)', filter: 'blur(40px)' }} aria-hidden="true" />
          
          <div className="relative card-glass rounded-3xl p-8 md:p-12">
            {/* Profile Section */}
            <div className="flex flex-col items-center text-center mb-10">
              <div className="relative mb-6">
                <div className="w-28 h-28 rounded-2xl flex items-center justify-center text-white font-bold text-4xl shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-300 overflow-hidden" style={{ background: 'var(--gradient-primary)' }} aria-hidden="true">
                  AG
                  {/* Shimmer */}
                ...
                <div className="absolute -bottom-2 -right-2 w-10 h-10 rounded-xl bg-green-500 flex items-center justify-center shadow-lg" aria-hidden="true">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10" role="list" aria-label="Contact options">
              <a 
              ...
              >
                <div className="p-3 rounded-xl bg-primary/10 group-hover:bg-primary/20 group-hover:scale-110 transition-all" aria-hidden="true">
                ...
                <ArrowUpRight className="w-4 h-4 text-muted-foreground opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all" aria-hidden="true" />
              </a>
              ...
              <div className="flex items-center gap-4 p-5 rounded-2xl bg-gradient-to-br from-secondary/50 to-secondary/30 border border-transparent">
                <div className="p-3 rounded-xl bg-primary/10" aria-hidden="true">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10" role="group" aria-label="Contact actions">
              <Button size="lg" className="gap-2 rounded-full px-8 btn-glow instant-hover" style={{ background: 'var(--gradient-primary)' }} asChild>
                <a href="mailto:aravindganteda@gmail.com" aria-label="Send an email to Aravind">
              ...
              <Button variant="outline" size="lg" className="gap-2 rounded-full px-8 hover:bg-primary/10 hover:border-primary/40 instant-hover" asChild>
                <a href="https://www.linkedin.com/in/ganteda-aravind-113b2427a/" target="_blank" rel="noopener noreferrer" aria-label="Message on LinkedIn (opens in new tab)">
            ...
            {/* Social Links */}
            <nav className="border-t border-border/50 pt-8" aria-label="Social media profiles">
                ...
                {socialLinks.map((social) => (
                  <li key={social.name}>
                    <a 
                      ...
                      aria-label={`${social.name}: ${social.username} (opens in new tab)`}
                    >
        ...
        {/* Bottom Message */}
        <p className={`text-center mt-10 transition-all duration-700 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} text-muted-foreground text-sm`}>
