      ...
      <div className="container max-w-6xl relative">
        ...
        <div className={`mb-16 transition-all duration-700 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="flex items-center gap-3 mb-8">
            <div className="p-2.5 rounded-xl text-white" style={{ background: 'var(--gradient-primary)' }}>
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-6 top-0 bottom-0 w-0.5 hidden md:block" style={{ background: 'var(--gradient-primary)' }} />
            ...
            {experiences.map((exp, index) => (
              <div key={index} className="relative group">
                ...
                <div className="md:ml-16">
                  {/* Glow effect */}
                  <div className="absolute -inset-0.5 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ background: 'var(--gradient-primary)', filter: 'blur(20px)', opacity: '0.15' }} />
            ...
            <div className="space-y-6">
              {education.map((edu, index) => (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div className="flex-1 card-glass rounded-xl p-5 hover:border-primary/40 instant-hover group-hover:translate-x-1 transition-all">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex-1">
                        {/* Mobile Icon */}
                        <div className={`md:hidden p-2.5 rounded-lg bg-gradient-to-br ${edu.gradient} text-white inline-flex mb-3`}>
